...
import { IconBriefcase2Filled, IconCircle, IconClockHour3, IconSearch, IconUser, IconUserCheck } from '@tabler/icons-react'
...
const HRpage = () => {
  ...
  return (
   ...
   <div>
    ...
    <Image src={teamwork} alt='teamwork' width={125}height={125}></Image>
    </Flex>
    </Card>
